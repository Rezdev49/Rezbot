...
let pp = 'https://telegra.ph/file/071837f2c198e3efc59c4.jpg'
...
\n${readMore}
`.trim()
conn.sendButtonLoc(m.chat, pp, str, wm, 'Beli pet', '.toko', m)
  }
handler.help = ['pet']
handler.tags = ['rpg']
handler.command = /^(pe|pet)$/i
handler.limit = true
handler.group = true
