...
let handler = async (m, { conn, args, text, usedPrefix, command }) => {
    ...
    try {
        ...
        let ini_txt = `乂•Title : *${get_result.title.romaji}*\n`
        ini_txt += `乂•English : *${get_result.title.english}*\n`
        ini_txt += `乂•Native : *${get_result.title.native}*\n\n`
...
handler.tags = ['anime']
handler.command = /^((cari|search)?anime(info|search)?)$/i
